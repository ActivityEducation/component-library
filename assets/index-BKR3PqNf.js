import{R as i,j as t}from"./iframe-DeWfNokQ.js";import{s as n}from"./emotion-styled.browser.esm-CcKH1BFe.js";import{c}from"./emotion-react.browser.esm-Azvj7r2W.js";const u=n.label`
  display: inline-flex;
  align-items: center;
  cursor: pointer;
...
`,p=n.div`
  ...
  ${e=>e.disabled&&c`
    ...
    `}
`,b=({label:e,indeterminate:o=!1,checked:a,disabled:r,onChange:d,id:h,...m})=>{const l=h||i.useId(),s=i.useRef(null);return i.useEffect(()=>{s.current&&(s.current.indeterminate=o)},[o]),t.jsxs(u,{className:r?"disabled":"",htmlFor:l,children:[t.jsx(f,{type:"checkbox",id:l,checked:a,disabled:r,onChange:d,ref:s,...m}),t.jsx(p,{checked:a,indeterminate:o,disabled:r,className:"checkbox-indicator"}),e&&t.jsx("span",{children:e})]})};b.__docgenInfo={description:`A Checkbox component for the AscendUCore Design System.
