import{r,j as s,t as ee}from"./iframe-CkUD85aG.js";import{s as l}from"./emotion-styled.browser.esm-YHkEzSHc.js";import{B as b}from"./index-BbGklbUC.js";import{S as te}from"./index-B8mPMhXM.js";import{P as re}from"./index-D5ksSLfO.js";import{C as oe}from"./index-DhuTWZIB.js";const V=t=>{const m=Math.floor(t/60),h=Math.floor(t%60),v=String(m).padStart(2,"0"),d=String(h).padStart(2,"0");return`${v}:${d}`},ne=l.div`
  position: relative;
  width: 100%;
