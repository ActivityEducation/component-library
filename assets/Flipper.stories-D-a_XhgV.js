import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{r as y}from"./iframe-C3uWE8cP.js";import{s as c,T as S,t as e}from"./index-0UhJA7dS.js";import{c as u}from"./emotion-react.browser.esm-BP-SUzAD.js";import{C as r}from"./index-BXsOkL7_.js";import{B as x}from"./index-DgNSwxsC.js";import"./index-CPXLxjDA.js";const R=c.div`
...
`,E=c(D)`
  ...
  ${t=>t.flipDirection==="vertical"?u`
        ...
        `:u`
          transform: rotateY(180deg);
        `}
`,k=({front:t,back:o,defaultFlipped:l=!1,isFlipped:i,onFlipChange:s,duration:$=.6,flipDirection:b="horizontal",onClick:w,...T})=>{const[I,B]=y.useState(l),C=i!==void 0?i:I,v=y.useCallback(()=>{const a=!C;i===void 0&&B(a),s?.(a)},[C,i,s]),z=y.useCallback(a=>{a.target===a.currentTarget&&v(),w?.(a)},[v,w]);return n.jsx(R,{...T,onClick:z,children:n.jsxs(q,{isFlipped:C,duration:$,flipDirection:b,children:[n.jsx(V,{flipDirection:b,children:t}),n.jsx(E,{flipDirection:b,children:o})]})})};k.__docgenInfo={description:`A component that provides a 3D flip animation for its content,
...
}`,...f.parameters?.docs?.source}}};const W=["DefaultHorizontal","DefaultVertical","LongerDuration","InitiallyFlipped","ControlledFlipper","GermanFlashcard"];export{g as ControlledFlipper,d as DefaultHorizontal,p as DefaultVertical,f as GermanFlashcard,m as InitiallyFlipped,h as LongerDuration,W as __namedExportsOrder,P as default};
