import{r,j as s,t as ee}from"./iframe-OEcLT8CW.js";import{s as l}from"./emotion-styled.browser.esm-CDovtSm7.js";import{B as b}from"./index-ClY7ognZ.js";import{S as te}from"./index-oiQMzIHI.js";import{P as re}from"./index-B3Zgj4ZA.js";import{C as oe}from"./index--GQInS8w.js";const V=t=>{const m=Math.floor(t/60),h=Math.floor(t%60),v=String(m).padStart(2,"0"),d=String(h).padStart(2,"0");return`${v}:${d}`},ne=l.div`
  position: relative;
  width: 100%;
