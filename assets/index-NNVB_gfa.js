import{j as o}from"./iframe-RAegngwO.js";import{c as a}from"./emotion-styled-base.browser.esm-DWA-sfXA.js";const c=a("span",{target:"e1qksbum0"})("display:inline-flex;align-items:center;justify-content:center;line-height:1;flex-shrink:0;vertical-align:middle;color:",e=>e.color||e.theme.colors.neutral[50],";transition:color 0.2s ease-in-out;",e=>{switch(e.size){case"xs":return`
          font-size: 12px;
          width: 12px;
          height: 12px;
        `;case"sm":return`
