import{e as m,j as o}from"./iframe-Ar-X8pQt.js";import{c as r}from"./emotion-styled-base.browser.esm-B8HPte8b.js";const h=r("label",{target:"e1s1cj312"})("display:inline-flex;align-items:center;cursor:pointer;user-select:none;font-family:",e=>e.theme.typography.fontFamily,";font-size:",e=>e.theme.typography.body.fontSize,";color:",e=>e.theme.colors.text.default,";&:hover .radio-indicator{border-color:",e=>e.theme.colors.primary[50],";}&:focus-within .radio-indicator{outline:2px solid ",e=>e.theme.colors.primary[60],";outline-offset:2px;}&.disabled{cursor:not-allowed;opacity:0.6;color:",e=>e.theme.colors.neutral[50],";}"),u=r("input",{target:"e1s1cj311"})({name:"2cco40",styles:"position:absolute;opacity:0;width:0;height:0;pointer-events:none"}),p=r("div",{target:"e1s1cj310"})("width:20px;height:20px;border:2px solid ",e=>e.theme.colors.border.default,";border-radius:",e=>e.theme.borderRadius.full,";display:flex;align-items:center;justify-content:center;margin-right:",e=>e.theme.spacing.sm,";transition:",e=>e.theme.transitions.fast,";flex-shrink:0;background-color:",e=>e.theme.colors.background.surface,";",e=>e.checked&&`
