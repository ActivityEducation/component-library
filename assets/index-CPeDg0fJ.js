import{r,R as E,j as o,t}from"./iframe-DeWfNokQ.js";import{s as h}from"./emotion-styled.browser.esm-CcKH1BFe.js";import{c as u}from"./emotion-react.browser.esm-Azvj7r2W.js";import{I as z}from"./index-4yhIEAYd.js";const N=h.div`
  display: inline-flex;
...
`,P=h.label`
  ...
  left: ${e=>{const m=`calc(20px + ${e.theme.spacing.sm} * 2)`,a=e.theme.spacing.lg,s=`calc(${m} + ${e.theme.spacing.xs})`;return e.hasLeadingAdornment?s:a}};
...
`,O=({label:e,helperText:m,error:a=!1,errorMessage:s,leading:l,trailing:c,value:n,defaultValue:f,onFocus:y,onBlur:b,onChange:x,disabled:d,id:v,...p})=>{const[g,$]=r.useState(!1),[F,w]=r.useState(n!==void 0?n:f!==void 0?f:""),I=r.useRef(null),T=!!F||I.current&&!!I.current.value,S=g||T,R=!!l,A=!!c;r.useEffect(()=>{n!==void 0&&w(n)},[n]);const C=r.useCallback(i=>{$(!0),y?.(i)},[y]),q=r.useCallback(i=>{$(!1),b?.(i)},[b]),L=r.useCallback(i=>{n===void 0&&w(i.target.value),x?.(i)},[n,x]),k=v||`input-${E.useId()}`;return o.jsxs(N,{...p,children:[o.jsxs(D,{isFocused:g,hasValue:T,error:a,disabled:d||!1,children:[l&&o.jsx(j,{children:typeof l=="string"?o.jsx(z,{name:l,size:"md",color:d?t.colors.neutral[50]:t.colors.neutral[50]}):l}),o.jsx(W,{id:k,onFocus:C,onBlur:q,onChange:L,value:n,defaultValue:f,disabled:d,placeholder:e&&!S?e:p.placeholder,hasLeading:R,hasTrailing:A,...p}),e&&o.jsx(P,{htmlFor:k,isFloating:S,isFocused:g,error:a,disabled:d||!1,hasLeadingAdornment:R,children:e}),c&&o.jsx(j,{children:typeof c=="string"?o.jsx(z,{name:c,size:"md",color:d?t.colors.neutral[50]:t.colors.neutral[50]}):c})]}),(m||a&&s)&&o.jsx("span",{style:{fontSize:t.typography.caption.fontSize,color:a?t.colors.error[40]:t.colors.neutral[50],marginTop:t.spacing.xxs,paddingLeft:t.spacing.sm},children:a&&s?s:m})]})};O.__docgenInfo={description:`An Input component with an outlined appearance for the AscendUCore Design System.
