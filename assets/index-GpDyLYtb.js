import{r,j as s,t as ee}from"./iframe-DZHKm7cV.js";import{s as l}from"./emotion-styled.browser.esm-B9gxxbr3.js";import{B as b}from"./index-CXwCvUvK.js";import{S as te}from"./index-BAld4t__.js";import{P as re}from"./index-CtIuLzZt.js";import{C as oe}from"./index-B2AR2asN.js";const V=t=>{const m=Math.floor(t/60),h=Math.floor(t%60),v=String(m).padStart(2,"0"),d=String(h).padStart(2,"0");return`${v}:${d}`},ne=l.div`
  position: relative;
  width: 100%;
