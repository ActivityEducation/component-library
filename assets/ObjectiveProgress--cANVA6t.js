import{j as e,t}from"./iframe-CkUD85aG.js";import{s as a}from"./emotion-styled.browser.esm-YHkEzSHc.js";import{C as f}from"./index-DhuTWZIB.js";import{P as g}from"./index-D5ksSLfO.js";import{I as h}from"./index-BvK6iIix.js";import{B as v}from"./index-BbGklbUC.js";const y=r=>{switch(r){case"achieved":return"success";case"on-track":return"primary";case"at-risk":return"warning";default:return"default"}},x=r=>{switch(r){case"achieved":return"fa-solid fa-check-circle";case"on-track":return"fa-solid fa-sync-alt";case"at-risk":return"fa-solid fa-exclamation-triangle";default:return"fa-solid fa-info-circle"}},b=a.div`
  display: flex;
  align-items: center;
  gap: ${t.spacing.md};
