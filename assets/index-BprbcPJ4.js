import{j as a}from"./iframe-CGsrx03R.js";import{c as i}from"./emotion-styled-base.browser.esm-BC397mIf.js";import{c as o}from"./emotion-react.browser.esm-BJCtjihh.js";import{I as s}from"./index-DkVkd4wc.js";const d=i("button",{target:"elgpv5l0"})("display:inline-flex;align-items:center;justify-content:center;cursor:pointer;border:none;border-radius:",e=>e.theme.borderRadius.md,";font-family:",e=>e.theme.typography.fontFamily,";transition:background-color 0.2s ease-in-out,color 0.2s ease-in-out,box-shadow 0.2s ease-in-out,border-color 0.2s ease-in-out;text-decoration:none;position:relative;",e=>{switch(e.size){case"sm":return`
        ...
        `}},e=>{switch(e.variant){case"secondary":return`
          ...
          ${e.active&&o("background-color:",e.theme.colors.secondary[50],";color:",e.theme.colors.secondary[100],";box-shadow:inset 0 0 0 2px ",e.theme.colors.secondary[30],";","")}
        `;case"tertiary":return`
          ...
          ${e.active&&o("background-color:",e.theme.colors.tertiary[30],";color:",e.theme.colors.tertiary[100],";box-shadow:inset 0 0 0 2px ",e.theme.colors.tertiary[20],";","")}
        `;case"ghost":return`
          ...
          ${e.active&&o("background-color:",e.theme.colors.neutral[90],";color:",e.theme.colors.primary[40],";box-shadow:inset 0 0 0 1px ",e.theme.colors.neutral[70],";","")}
        `;case"destructive":return`
          ...
          ${e.active&&o("background-color:",e.theme.colors.error[50],";color:",e.theme.colors.error[100],";box-shadow:inset 0 0 0 2px ",e.theme.colors.error[30],";","")}
