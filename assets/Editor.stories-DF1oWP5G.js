import{r as a,j as t,t as b,T as D}from"./iframe-CI6SfAYv.js";import{s as H}from"./emotion-styled.browser.esm-BNvuT_w2.js";import{a as k,T as M}from"./index-BE3UzUWV.js";import{B as l}from"./index-35YDmkMi.js";import{I as V}from"./index-VsfT2vE2.js";import{S as J,O as p}from"./index-ZS7eBlIS.js";import{I as s}from"./index-17Ykmepx.js";import{M as K,a as S}from"./index-C4UiIYhl.js";import"./emotion-react.browser.esm-C8KZ_cib.js";const u=e=>{if(typeof window>"u"||!window.getSelection)return!1;try{return document.queryCommandState(e)}catch{return!1}},Q=e=>{if(typeof window>"u"||!window.getSelection||!e)return"p";const m=window.getSelection();if(!m||m.rangeCount===0)return"p";let h=m.getRangeAt(0).commonAncestorContainer;for(;h&&h!==e;){if(h.nodeType===Node.ELEMENT_NODE){const n=h.tagName.toLowerCase();if(["p","h1","h2","h3","h4","h5","h6","ul","ol","li","div","pre"].includes(n))return n}h=h.parentNode}return"p"},X=H.div`
