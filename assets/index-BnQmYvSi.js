import{j as a}from"./iframe-RAegngwO.js";import{c as i}from"./emotion-styled-base.browser.esm-DWA-sfXA.js";import{c as o}from"./emotion-react.browser.esm-zPk2XnfE.js";import{I as s}from"./index-NNVB_gfa.js";const d=i("button",{target:"elgpv5l0"})("display:inline-flex;align-items:center;justify-content:center;cursor:pointer;border:none;border-radius:",e=>e.theme.borderRadius.md,";font-family:",e=>e.theme.typography.fontFamily,";transition:background-color 0.2s ease-in-out,color 0.2s ease-in-out,box-shadow 0.2s ease-in-out,border-color 0.2s ease-in-out;text-decoration:none;position:relative;",e=>{switch(e.size){case"sm":return`
