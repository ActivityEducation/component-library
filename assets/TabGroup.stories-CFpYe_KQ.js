import{j as t}from"./jsx-runtime-D_zvdyIk.js";import{r as d}from"./iframe-C3uWE8cP.js";import{s as f,T as x,t as a}from"./index-0UhJA7dS.js";import{C as u}from"./index-BXsOkL7_.js";const w=f.button`
...
`,s=({children:e,value:n,isActive:o=!1,onTabSelect:l,onClick:c,...i})=>{const v=b=>{l?.(n),c?.(b)};return t.jsx(w,{isActive:o,onClick:v,...i,children:e})},j=f.div`
...
}`,...g.parameters?.docs?.source}}};const $=["Default","InitialActiveTab","WithDisabledTabs","InteractiveTabsWithContent"];export{h as Default,p as InitialActiveTab,g as InteractiveTabsWithContent,m as WithDisabledTabs,$ as __namedExportsOrder,V as default};
