import{r,j as s,t as ee}from"./iframe-DBjxWcSu.js";import{s as l}from"./emotion-styled.browser.esm-BYbfZwar.js";import{B as b}from"./index-BiwRjp0i.js";import{S as te}from"./index-CvWfBAOB.js";import{P as re}from"./index-B0cpd8Ed.js";import{C as oe}from"./index--bmTD6EN.js";const V=t=>{const m=Math.floor(t/60),h=Math.floor(t%60),v=String(m).padStart(2,"0"),d=String(h).padStart(2,"0");return`${v}:${d}`},ne=l.div`
  position: relative;
  width: 100%;
