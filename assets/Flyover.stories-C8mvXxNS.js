import{j as o}from"./jsx-runtime-D_zvdyIk.js";import{r as p}from"./iframe-C3uWE8cP.js";import{t as e,s as Y,T as q}from"./index-0UhJA7dS.js";import{c as _}from"./emotion-react.browser.esm-BP-SUzAD.js";import{C as N}from"./index-BXsOkL7_.js";const G=Y.span`
...
| 'fix-top-right'
| 'fix-bottom-left'
| 'fix-bottom-right'`,elements:[{name:"literal",value:"'top'"},{name:"literal",value:"'bottom'"},{name:"literal",value:"'left'"},{name:"literal",value:"'right'"},{name:"literal",value:"'fix-top-left'"},{name:"literal",value:"'fix-top-right'"},{name:"literal",value:"'fix-bottom-left'"},{name:"literal",value:"'fix-bottom-right'"}]},description:`The preferred position of the popover relative to the trigger.
...
}`,...E.parameters?.docs?.source}}};const oe=["Default","PositionTop","PositionLeft","PositionRight","InParagraphWithAutoFlip","FixedTopLeft","FixedTopRight","FixedBottomLeft","FixedBottomRight"];export{F as Default,R as FixedBottomLeft,E as FixedBottomRight,S as FixedTopLeft,P as FixedTopRight,k as InParagraphWithAutoFlip,j as PositionLeft,$ as PositionRight,T as PositionTop,oe as __namedExportsOrder,te as default};
