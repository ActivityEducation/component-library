import{r as a,j as t,t as z}from"./iframe-XJf-RO9W.js";import{s as S}from"./emotion-styled.browser.esm-Zt9Xnlbb.js";import{a as k,T as A}from"./index-hKkMw5Tq.js";import{B as l}from"./index-ByguWD-9.js";import{I as W}from"./index-D1S9llNI.js";import{S as V,O as f}from"./index-DwKSXbOR.js";import{I as s}from"./index-guuBgZ9n.js";import{M as G,a as w}from"./index-DaQSjhOt.js";const m=e=>{if(typeof window>"u"||!window.getSelection)return!1;try{return document.queryCommandState(e)}catch{return!1}},P=e=>{if(typeof window>"u"||!window.getSelection||!e)return"p";const u=window.getSelection();if(!u||u.rangeCount===0)return"p";let h=u.getRangeAt(0).commonAncestorContainer;for(;h&&h!==e;){if(h.nodeType===Node.ELEMENT_NODE){const n=h.tagName.toLowerCase();if(["p","h1","h2","h3","h4","h5","h6","ul","ol","li","div","pre"].includes(n))return n}h=h.parentNode}return"p"},Y=S.div`
