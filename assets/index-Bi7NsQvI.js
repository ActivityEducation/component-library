import{r,j as s,t as ee}from"./iframe-CUhOUwcP.js";import{s as l}from"./emotion-styled.browser.esm-DVCxs-Ot.js";import{B as b}from"./index-DWmN52dn.js";import{S as te}from"./index-Cu_Bt6nJ.js";import{P as re}from"./index-CQG4qJdo.js";import{C as oe}from"./index-FpduDP9J.js";const V=t=>{const m=Math.floor(t/60),h=Math.floor(t%60),v=String(m).padStart(2,"0"),d=String(h).padStart(2,"0");return`${v}:${d}`},ne=l.div`
  position: relative;
  width: 100%;
