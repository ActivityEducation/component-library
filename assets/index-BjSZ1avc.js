import{j as o}from"./iframe-DBjxWcSu.js";import{s as a}from"./emotion-styled.browser.esm-BYbfZwar.js";const c=a.span`
...
`,d=({name:e,src:t,children:i,size:r="md",color:s,...l})=>{let n=null;return t?n=o.jsx("img",{src:t,alt:e||"icon"}):e?n=o.jsx("i",{className:e}):i?n=i:console.warn('Icon component rendered without a "name", "src", or "children" prop. No icon will be displayed.'),o.jsx(c,{size:r,color:s,"aria-hidden":!e&&!t&&!i?!0:void 0,...l,children:n})};d.__docgenInfo={description:`A reusable Icon component for the AscendUCore Design System.
