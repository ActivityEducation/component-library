import{r as a,j as t,t as z}from"./iframe-DZHKm7cV.js";import{s as S}from"./emotion-styled.browser.esm-B9gxxbr3.js";import{a as k,T as A}from"./index-DaSNgQEb.js";import{B as l}from"./index-CXwCvUvK.js";import{I as W}from"./index-C83lfV4j.js";import{S as V,O as f}from"./index-Cztm2VnL.js";import{I as s}from"./index-DA9UlLMO.js";import{M as G,a as w}from"./index-CDYCtHmw.js";const m=e=>{if(typeof window>"u"||!window.getSelection)return!1;try{return document.queryCommandState(e)}catch{return!1}},P=e=>{if(typeof window>"u"||!window.getSelection||!e)return"p";const u=window.getSelection();if(!u||u.rangeCount===0)return"p";let h=u.getRangeAt(0).commonAncestorContainer;for(;h&&h!==e;){if(h.nodeType===Node.ELEMENT_NODE){const n=h.tagName.toLowerCase();if(["p","h1","h2","h3","h4","h5","h6","ul","ol","li","div","pre"].includes(n))return n}h=h.parentNode}return"p"},Y=S.div`
