import{j as e,t}from"./iframe-OEcLT8CW.js";import{s as a}from"./emotion-styled.browser.esm-CDovtSm7.js";import{C as f}from"./index--GQInS8w.js";import{P as g}from"./index-B3Zgj4ZA.js";import{I as h}from"./index-GB8cKMHG.js";import{B as v}from"./index-ClY7ognZ.js";const y=r=>{switch(r){case"achieved":return"success";case"on-track":return"primary";case"at-risk":return"warning";default:return"default"}},x=r=>{switch(r){case"achieved":return"fa-solid fa-check-circle";case"on-track":return"fa-solid fa-sync-alt";case"at-risk":return"fa-solid fa-exclamation-triangle";default:return"fa-solid fa-info-circle"}},b=a.div`
  display: flex;
  align-items: center;
  gap: ${t.spacing.md};
