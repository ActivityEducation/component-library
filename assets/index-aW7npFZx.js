import{j as r}from"./iframe-CkUD85aG.js";import{s as t}from"./emotion-styled.browser.esm-YHkEzSHc.js";import{c as n}from"./emotion-react.browser.esm-Cwb0n8oH.js";const s=t.div`
  display: flex;
  gap: ${e=>e.theme.spacing.sm}; /* Default gap between items */
  padding: ${e=>e.theme.spacing.xs} ${e=>e.theme.spacing.md};
  background: ${e=>e.theme.colors.background.surface};
