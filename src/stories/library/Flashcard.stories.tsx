...
const meta: Meta<typeof Flashcard> = {
  ...
  argTypes: {
    model: {
      control: "object",
      description:
        "The edu:FlashcardModel object that defines the card structure.",
    },
    data: {
      control: "object",
...
const apiFlashcardData = {
  ...
  name: "der Hund",
  "edu:model":
    "http://localhost/api/objects/9ff37253-cb29-4067-b023-0ab8a9b3c156",
  "edu:fieldsData": {
    word: "der Hund",
